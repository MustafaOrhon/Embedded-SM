...
static QState Clock_Alarm_es_error(Clock_Alarm * const me);
static QState Clock_Alarm_es_error_off(Clock_Alarm * const me);
static QState Clock_Alarm_es_err_on(Clock_Alarm * const me);
...
/*.$define${HSMs::ALARM_BELL_CHAR[8]} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${HSMs::ALARM_BELL_CHAR[8]} .............................................*/
static uint8_t ALARM_BELL_CHAR[8] ={0b00100,0b01110,0b01110,0b01110,0b11111,0b00000,0b00100,0b00000};
/*.$enddef${HSMs::ALARM_BELL_CHAR[8]} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
...
/*.${HSMs::Clock_Alarm::get_current_time} ..................................*/
static uint32_t Clock_Alarm_get_current_time(void) {
...
/*.${HSMs::Clock_Alarm::update_current_time} ...............................*/
static void Clock_Alarm_update_current_time(void) {
...
/*.${HSMs::Clock_Alarm::set_current_time} ..................................*/
static void Clock_Alarm_set_current_time(uint32_t new_current_time) {
    uint8_t save_sreg;
    save_sreg = SREG;
    cli();
...
static QState Clock_Alarm_Clock(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case ALARM_SIG: {
            ...
            if (( me->alarm_status == ALARM_ON && Clock_Alarm_get_current_time()/10 == me->alarm_time)) {
...
static QState Clock_Alarm_Ticking(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Ticking} */
        case Q_ENTRY_SIG: {
            display_curr_time(me,TICKING_CURRENT_TIME_ROW,TICKING_CURRENT_TIME_COL);
            status_ = Q_HANDLED();
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Ticking} */
        ...
        case SET_SIG: {
            me->temp_time = Clock_Alarm_get_current_time()/10;
        ...
        case TICK_SIG: {
            ...
            if(me->alarm_status == ALARM_ON) {
                lcd_create_custom_char(0, ALARM_BELL_CHAR);
...
static QState Clock_Alarm_Clock_Setting(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::OK} */
        case OK_SIG: {
            if(me->temp_format != FORMAT_24H)
            {
            ...
            me->temp_time *= 10UL;
            Clock_Alarm_set_current_time(me->temp_time);
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::OK::[0]} */
            if (0) {
                status_ = Q_HANDLED();
            }
            else {
...
static QState Clock_Alarm_cs_error(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::initial} */
        case Q_INIT_SIG: {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::OK} */
        case OK_SIG: {
            status_ = Q_HANDLED();
            break;
        }
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_on} */
static QState Clock_Alarm_err_on(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_on} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_on::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_on::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_off} */
static QState Clock_Alarm_err_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_off::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Clock_Setting::cs_error::err_off::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_err_on);
            }
...
static QState Clock_Alarm_Alarm_Setting(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_as_hour_d1);
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::TICK} */
        case TICK_SIG: {
            display_curr_time(me,ALARM_SETTING_CURR_TIME_ROW,ALARM_SETTING_CURR_TIME_COL);
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::OK} */
        case OK_SIG: {
            ...
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::OK::[0]} */
            if (0) {
                status_ = Q_HANDLED();
            }
            else {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d2} .....*/
static QState Clock_Alarm_as_hour_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
            me->temp_time -=  DIGIT2(GET_HOUR(me->temp_time))* 3600UL;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d1} ......*/
static QState Clock_Alarm_as_min_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
            me->temp_time -= DIGIT1(GET_MIN(me->temp_time)) * 10UL * 60UL;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d2} ......*/
static QState Clock_Alarm_as_min_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
            me->temp_time -= DIGIT2(GET_MIN(me->temp_time)) * 60UL;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_min_d2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d1} ......*/
static QState Clock_Alarm_as_sec_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
            me->temp_time -= DIGIT1(GET_SEC(me->temp_time)) * 10UL;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d2} ......*/
static QState Clock_Alarm_as_sec_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
            me->temp_time -= DIGIT2(GET_SEC(me->temp_time));
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_sec_d2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d1} .....*/
static QState Clock_Alarm_as_hour_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 3;
            me->temp_time -=  DIGIT1(GET_HOUR(me->temp_time)) * 10UL * 3600UL;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_hour_d1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format} ......*/
static QState Clock_Alarm_as_format(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format::SET} */
        case SET_SIG: {
            String msg;
            if(me->temp_format == FORMAT_24H){
                me->temp_format = FORMAT_AM;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format::OK} */
        case OK_SIG: {
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format::OK::[is_time_set_error(me->temp_time~} */
            if (is_time_set_error(me->temp_time,(time_format_t)me->temp_format)) {
                status_ = Q_TRAN(&Clock_Alarm_es_error);
            }
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::as_format::OK::[else]} */
            else {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error} .......*/
static QState Clock_Alarm_es_error(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_es_err_on);
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::OK} */
        case OK_SIG: {
            status_ = Q_HANDLED();
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::TICK} */
        case TICK_SIG: {
            status_ = Q_HANDLED();
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::SET} */
        case SET_SIG: {
            display_cursor_on_blinkon();
            status_ = Q_TRAN(&Clock_Alarm_Alarm_Setting);
            break;
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_error_off} */
static QState Clock_Alarm_es_error_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_error_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_error_off::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_error_off::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_es_err_on);
            }
        ...
        default: {
            status_ = Q_SUPER(&Clock_Alarm_es_error);
            break;
        }
    }
    return status_;
}
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_err_on} */
static QState Clock_Alarm_es_err_on(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_err_on} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_err_on::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::es_error::es_err_on::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_es_error_off);
            }
            else {
                status_ = Q_UNHANDLED();
            }
...
/*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::alarm_on_off} ...*/
static QState Clock_Alarm_alarm_on_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::alarm_on_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Setting::Alarm_Setting::alarm_on_off::SET} */
        case SET_SIG: {
            if(me->temp_digit){
                display_write("ALARM OFF",ALARM_SETTING_STATUS_ROW,ALARM_SETTING_STATUS_COL);
                me->temp_digit = 0;
...
void display_curr_time(Clock_Alarm *me,uint8_t row, uint8_t col){
    ...
    uint32_t time24h = Clock_Alarm_get_current_time();
